  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-[var(--stint-bg)] via-[var(--stint-bg)] to-[var(--stint-primary)]/5 p-4 relative overflow-hidden">
      ...
      <div className="relative w-full max-w-sm rounded-2xl bg-[var(--stint-bg-card)] border border-[var(--stint-border)] shadow-[var(--stint-shadow-card)] p-8 flex flex-col items-center">
        ...
        <a
          href="/auth/google"
          className="w-full flex items-center justify-center gap-2 py-3 px-4 rounded-xl bg-[var(--stint-primary)] text-white font-semibold hover:bg-[var(--stint-primary-dark)] transition-all shadow-lg shadow-[var(--stint-primary)]/20 hover:shadow-xl hover:-translate-y-0.5 active:translate-y-0 text-sm"
        >
        ...
        {/* IP Access Direct Admin Login */}
        <a
          href="/auth/ip-admin-login"
          className="w-full mt-3 flex items-center justify-center gap-2 py-2.5 px-4 rounded-xl bg-[var(--stint-bg-elevated)] border border-[var(--stint-border)] text-[var(--stint-text)] font-semibold hover:border-[var(--stint-primary)] transition-all text-xs"
        >
          ⚡ Sign in as Admin (IP Access Mode)
        </a>
      </div>
